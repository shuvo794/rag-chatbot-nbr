        ...
        <div className="p-6">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              disabled={ingesting}
              className={`w-full flex items-center justify-center gap-2.5 py-3 px-4 rounded-xl text-sm font-semibold border transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] ${
                ingesting 
